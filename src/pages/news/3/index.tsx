...
const NewsItemPage2: React.FC = () => {
  ...
  return (
    <MetaLayer
      title='Stay with Ukraine | News Section | The Discussion About Preservation of Cultural Heritage and Economic Cooperation of Poland and Ukraine in the Volyn Region'
      description='The Discussion About Preservation of Cultural Heritage and Economic Cooperation of Poland and Ukraine in the Volyn Region'
